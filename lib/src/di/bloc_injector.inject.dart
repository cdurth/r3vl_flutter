...
import '../resources/youtube_api_provider.dart' as _i9;
import '../blocs/movie_detail_bloc.dart' as _i10;
import '../blocs/songSearch_bloc.dart' as _i11;
...
class BlocInjector$Injector implements _i1.BlocInjector {
  ...
  _i7.App _createApp() => _i7.App(
      _createMoviesBloc(), _createMovieDetailBloc(), _createSongSearchBloc());
  _i8.MoviesBloc _createMoviesBloc() => _i8.MoviesBloc(_createRepository());
  _i5.Repository _createRepository() => _singletonRepository ??= _blocModule
      .repository(_createMovieApiProvider(), _createYoutubeApiProvider());
  ...
  _i9.YoutubeApiProvider _createYoutubeApiProvider() =>
      _i9.YoutubeApiProvider(_createClient());
  _i10.MovieDetailBloc _createMovieDetailBloc() =>
      _i10.MovieDetailBloc(_createRepository());
  _i11.SongSearchBloc _createSongSearchBloc() =>
      _i11.SongSearchBloc(_createRepository());
  @override
